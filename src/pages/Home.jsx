      ...
      <div className={styles.subContainer}>
        <div>
          ...
          <p className={styles.infoText}>
            {`I'm a freelance web developer specializing in JavaScript, React, and Firebase.
...
I work with clients locally and internationally, with a strong commitment to quality, reliability, and meeting deadlines.`}
          </p>
